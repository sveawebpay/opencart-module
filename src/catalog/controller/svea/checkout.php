...
class ControllerSveaCheckout extends Controller
{
    ...
    {
        if($this->session->data['language'] == "sv-se" || $this->session->data['language'] == "se")
        {
            return 203;
        }
        else if($this->session->data['language'] == "nn-no" || $this->session->data['language'] == "no")
        {
            return 160;
        }
        else if($this->session->data['language'] == "fi-fi" || $this->session->data['language'] == "fi")
        {
            return 72;
        }
        else
...
//        $this->session->data['sco_postcode'] = '';
        ...
        $this->response->setOutput($this->load->view('default/template/svea/checkout.tpl', $data));
    }
