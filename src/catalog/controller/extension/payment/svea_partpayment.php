...
class ControllerExtensionPaymentSveapartpayment extends SveaCommon {
    ...
    public function index() {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/extension/payment/svea_partpayment.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/extension/payment/svea_partpayment.tpl', $data);
        } elseif(floatval(VERSION) >= 2.2) {
            return $this->load->view('extension/payment/svea_partpayment', $data);
        } else {
            return $this->load->view('default/template/extension/payment/svea_partpayment.tpl', $data);
        }
