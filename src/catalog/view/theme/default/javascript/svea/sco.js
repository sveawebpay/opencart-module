$(document).ready(function () {
  ...
  shippingEl.on('change', function (event) {
    ...
    $.ajax({
      type: 'POST',
      url: 'index.php?route=svea/shipping/save',
      data: shippingEl,
      dataType: 'json',
      success: function () {
  ...
  $('#comment').on('blur', function (event) {
    $.ajax({
      type: 'POST',
      url: 'index.php?route=svea/comment',
      data: $('#comment'),
      dataType: 'json',
      success: function (json) {
        if ($('#comment').val() !== '') {
  ...
  $(document).on('click', '#sco-coupon-add', function () {
    $.ajax({
      url: 'index.php?route=svea/coupon/add',
      type: 'post',
      ...
      success: function (json) {
        if (json['error']) {
          ...
          couponEl.load('index.php?route=svea/coupon');
          updateCartInformation();
        }
      }
    });
  ...
  $(document).on('click', '#sco-coupon-remove', function () {
    $.ajax({
      url: 'index.php?route=svea/coupon/remove',
      type: 'post',
      dataType: 'json',
      beforeSend: function () {
        $('.alert').remove();
  ...
  $(document).on('click', '#sco-voucher-add', function () {
    $.ajax({
      url: 'index.php?route=svea/voucher/add',
      type: 'post',
      ...
      success: function (json) {
        if (json['error']) {
          ...
          voucherEl.load('index.php?route=svea/voucher');
          updateCartInformation();
        }
      }
    });
  ...
  $(document).on('click', '#sco-voucher-remove', function () {
    $.ajax({
      url: 'index.php?route=svea/voucher/remove',
      type: 'post',
      dataType: 'json',
      beforeSend: function () {
        $('.alert').remove();
  ...
  cartEl.load('index.php?route=svea/cart');
  couponEl.load('index.php?route=svea/coupon');
  voucherEl.load('index.php?route=svea/voucher');
  ...
  function initialCheckoutPayment(forceCreate) {
    ...
    var url = 'index.php?route=svea/payment';
    if (forceCreate) {
      url += '&create=true';
    }
