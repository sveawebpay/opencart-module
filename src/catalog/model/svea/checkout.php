...
class ModelSveaCheckout extends Model
{
    ...
    public function addOrder($order)
    {
        ...
        // Opencart 2.0 and 2.1 don't have same methods for voucher
        if (method_exists($this->model_total_voucher, 'disableVoucher')) {
            $this->model_total_voucher->disableVoucher($order_id);
        } else {
            $this->model_total_voucher->unconfirm($order_id);
        }
