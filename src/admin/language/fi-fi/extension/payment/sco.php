...
$_['text_edit']         = 'Muokata Svea Checkout';
$_['text_no_settings']  = 'Svea Checkoutin moduuli löytyy kategoriasta "Moduuli".';
$_['text_sco']          = '<svg style="fill: #002c50;" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="94" height="35" version="1.1" viewBox="0 0 2540 930" xmlns:xlink="http://www.w3.org/1999/xlink">
 <g>
