    ...
    <div class="panel-body">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sveainvoice" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="form-group">
                    <label for="svea_invoice_hide_svea_comments" class="col-sm-2 control-label">
                        <span data-toggle="tooltip" title="<?php echo $entry_hide_svea_comments_tooltip; ?>"><?php echo $entry_hide_svea_comments; ?></span>
                    </label>
                    <div class="col-sm-9">
                        <select name="svea_invoice_hide_svea_comments"  class="form-control">
                            <?php if ($svea_invoice_hide_svea_comments) { ?>
                            <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                            <option value="0"><?php echo $text_disabled; ?></option>
                            <?php } else { ?>
                            <option value="1"><?php echo $text_enabled; ?></option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                        ...
                        <div class="checkbox">
                            <label>
                                <?php if (in_array($order_status['order_status_id'], $svea_invoice_deliver_status)) { ?>
                                <input type="checkbox" name="svea_invoice_deliver_status[]" value="<?php echo $order_status['order_status_id']; ?>" checked="checked" />
                                <?php echo $order_status['name']; ?>
                                <?php } else { ?>
                                <input type="checkbox" name="svea_invoice_deliver_status[]" value="<?php echo $order_status['order_status_id']; ?>" />
                                <?php echo $order_status['name']; ?>
                                <?php } ?>
                            </label>
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                        ...
                        <div class="checkbox">
                            <label>
                                <?php if (in_array($order_status['order_status_id'], $svea_invoice_cancel_credit_status)) { ?>
                                <input type="checkbox" name="svea_invoice_cancel_credit_status[]" value="<?php echo $order_status['order_status_id']; ?>" checked="checked" />
                                <?php echo $order_status['name']; ?>
                                <?php } else { ?>
                                <input type="checkbox" name="svea_invoice_cancel_credit_status[]" value="<?php echo $order_status['order_status_id']; ?>" />
                                <?php echo $order_status['name']; ?>
                                <?php } ?>
                            </label>
                        </div>
