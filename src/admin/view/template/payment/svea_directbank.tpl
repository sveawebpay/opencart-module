        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sveadirectbank" class="form-horizontal">
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label for="svea_directbank_order_status_id" class="col-sm-3 control-label">
                ...
                <div class="form-group">
                    <label for="svea_directbank_refunded_status_id" class="col-sm-3 control-label">
                     ...
                     <div class="col-sm-9">
                        <select name="svea_directbank_refunded_status_id">
                            <?php foreach ($order_statuses as $order_status) {
                                if ($order_status['order_status_id'] == $svea_directbank_refunded_status_id) { ?>
                             <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                                 <?php } else { ?>
                             <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                                  <?php } ?>
