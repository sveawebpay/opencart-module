    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        ...
        <tr>
          ...
          <td><select name="svea_directbank_status">
        ...
        <tr>
            ...
            <td>
                <input name="svea_directbank_merchant_id" type="text" value="<?php echo $svea_directbank_merchant_id; ?>" />
            </td>
        </tr>
        <tr>
            <td><?php echo $entry_sw; ?>:</td>
            <td>
                <input name="svea_directbank_sw" type="password" value="<?php echo $svea_directbank_sw; ?>" />
            </td>
        </tr>
      </table>
    </form>
