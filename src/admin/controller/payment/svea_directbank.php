...
class ControllerPaymentsveadirectbank extends Controller {
	...
	public function index() { 
        ...
        $this->data['svea_directbank_merchant_id'] = $this->config->get('svea_directbank_merchant_id');
        $this->data['svea_directbank_sw']          = $this->config->get('svea_card_sw');
        $this->data['svea_directbank_testmode']    = $this->config->get('svea_card_testmode');
