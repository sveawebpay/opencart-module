...
class ControllerPaymentsveadirectbank extends Controller {
	...
	public function index() {
        ...
        $this->data['value_merchant_test'] = $this->config->get('svea_directbank_merchant_id_test');
        $this->data['value_sw_test'] = $this->config->get('svea_directbank_sw_test');
        $this->data['value_merchant_prod'] = $this->config->get('svea_directbank_merchant_id_prod');
        $this->data['value_sw_prod'] = $this->config->get('svea_directbank_sw_prod');
      ...
      //statuses
        ...
        if (isset($this->request->post['svea_directbank_refunded_status_id'])) {
                $this->data['svea_directbank_refunded_status_id'] = $this->request->post['svea_directbank_refunded_status_id'];
        } else {
                $this->data['svea_directbank_refunded_status_id'] = $this->config->get('svea_directbank_refunded_status_id');
        }
