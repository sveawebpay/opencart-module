...
## OpenCart 2.3 - Svea checkout and payment modules

* Supports OpenCart 2.3.0.0 - 2.3.0.2 (older and newer versions can be found in the branches)
...
This module is tested with a clean installation of [OpenCart 2.3.0.2](http://www.opencart.com/index.php?route=download/download) with [vQmod](https://github.com/vqmod) and it uses the latest Svea [php-integration](https://github.com/sveawebpay/php-integration) package.
