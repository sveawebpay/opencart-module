...
This module is tested with a clean installation of [OpenCart 2.1.0.2](http://www.opencart.com/index.php?route=download/download) with [vQmod](https://github.com/vqmod) and it uses the latest Svea [php-integration](https://github.com/sveawebpay/php-integration) package.
...
* Save ![Geo zones](docs/image/Geo_zones.png "Geo zones")
...
![Checkout general](docs/image/Checkout_authorization.png "Checkout general")
